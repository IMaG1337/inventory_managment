...
Revision ID: 15d4687ac5fe
Revises: cbe17d088324
Create Date: 2022-12-20 13:42:00.257974
...
revision = '15d4687ac5fe'
down_revision = 'cbe17d088324'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sa.Column('uid', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('name', sa.VARCHAR(), nullable=False),
    sa.Column('receipt_data', sa.DATE(), nullable=True),
    ...
    sa.Column('useful_life', sa.DATE(), nullable=True),
    sa.Column('note', sa.VARCHAR(), nullable=False),
    sa.Column('write_off_day', sa.DATE(), nullable=True),
    ...
    op.create_index(op.f('ix_inventory_card_inventory_info_uid'), 'inventory_card', ['inventory_info_uid'], unique=False)
    ...
    sa.Column('date', sa.DateTime(), nullable=False),
    sa.Column('employee_uid', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('room_uid_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('inventory_card_uid', postgresql.UUID(as_uuid=True), nullable=False),
    sa.ForeignKeyConstraint(['employee_uid'], ['employee.uid'], ),
    sa.ForeignKeyConstraint(['inventory_card_uid'], ['inventory_card.uid'], ),
    sa.ForeignKeyConstraint(['room_uid_id'], ['rooms.uid'], ),
    sa.PrimaryKeyConstraint('uid'),
    sa.UniqueConstraint('uid')
    )
